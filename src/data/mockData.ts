...
export const MOCK_PACKAGING_INVENTORY: PackagingMaterialMaster[] = [
  {
    id: 'MAT-CB-S',
    name: 'Small Corrugated Carton',
    category: 'Paper/Cardboard',
    packagingClass: 'Primary',
    useType: 'Single-Use',
    availableStock: 3200,
    stockUnit: 'pcs',
    ...
    co2PerKg: 0.82,
    description: 'Small double-wall carton for compact components (Fuel Injectors, Sensors, Service Kits).'
  },
  {
    id: 'MAT-CB-M',
    ...
    ppwrMaterialCode: 'PAP-20',
    co2PerKg: 0.82,
    description: 'Standard medium double-wall shipping carton (Gear Assemblies, Brake Assemblies).'
  },
  {
    id: 'MAT-CB-L',
    ...
    ppwrMaterialCode: 'PAP-20',
    co2PerKg: 0.82,
    description: 'Reinforced 5-ply heavy carton (Turbochargers, Industrial Valves, Actuators).'
  },
  {
    id: 'MAT-CB-XL',
    name: 'Extra-Large Bulk Carton',
    category: 'Paper/Cardboard',
    packagingClass: 'Primary',
    useType: 'Single-Use',
    availableStock: 950,
    stockUnit: 'pcs',
    weightPerUnitKg: 1.20,
    unitName: 'pcs',
    ...
    ppwrMaterialCode: 'PAP-20',
    co2PerKg: 0.82,
    description: 'Heavy duty bulk shipping container for oversized powertrain modules.'
  },
  {
    id: 'MAT-001',
    name: 'Cardboard Box (Standard Medium)',
    category: 'Paper/Cardboard',
    packagingClass: 'Primary',
    useType: 'Single-Use',
    availableStock: 2500,
